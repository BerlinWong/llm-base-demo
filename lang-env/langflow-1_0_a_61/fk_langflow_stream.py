...
FLOW_ID = "263ee5e6-8268-42da-8443-37f6bb3421cd"
...
Run it like: python <your file>.py "your message here" --endpoint "your_endpoint" --tweaks '{"key": "value"}'""",
    ...
    parser.add_argument("--message", type=str, help="The message to send to the flow", default=msg)
...
if __name__ == "__main__":
    main(msg="我有五本书给三个小朋友分，如何才能分配均匀")
